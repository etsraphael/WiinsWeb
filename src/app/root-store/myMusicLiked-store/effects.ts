...
export class MyMusicLikedStoreEffects {
  ...
  @Effect()
  loadMyMusic: Observable<featureActions.ActionsMyMusic> = this.actions$.pipe(
  ...
  @Effect()
  likeMusic: Observable<featureActions.ActionsMyMusic> = this.actions$.pipe(
  ...
  @Effect()
  dislikeMusic: Observable<featureActions.ActionsMyMusic> = this.actions$.pipe(
