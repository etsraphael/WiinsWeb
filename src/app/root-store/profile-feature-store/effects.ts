...
export class ProfileFeatureEffects {
  ...
  @Effect()
  loadCurrentUserProfile$: Observable<Action> = this.actions$.pipe(
  ...
  @Effect()
  getProfileByPseudo$: Observable<Action> = this.actions$.pipe(
  ...
  @Effect()
  getProfileById$: Observable<Action> = this.actions$.pipe(
  ...
  @Effect()
  updateBtnFolow$: Observable<Action> = this.actions$.pipe(
  ...
  @Effect()
  updateProfileAvatar$: Observable<Action> = this.actions$.pipe(
  ...
  @Effect()
  updateProfileCover$: Observable<Action> = this.actions$.pipe(
