...
export class ResponseFeatureStoreEffects {
  constructor(private dataService: CommentService, private actions$: Actions) { }
    ...
    @Effect()
    getResponse: Observable<ActionsResponse> = this.actions$.pipe(
    ...
    @Effect()
    getResponsePlaylist: Observable<ActionsResponse> = this.actions$.pipe(
    ...
    @Effect()
    creatResponse: Observable<ActionsResponse> = this.actions$.pipe(
